...
import { openNotification, successNotifiaction } from '../Shared/NotificationMessages';
...
class DescriptionForm extends Component {
    ...
    handleSubmit = e => {
        ...
        this.props.form.validateFields((err, values) => {
            if (!err) {
                ...
                this.runSimulation(projectId, {...values, option: 'generate'})
            }
        });
    };
    ...
    render() {
        ...
        const descriptiontNameError = isFieldTouched('description') && getFieldError('description');

        return (
            <>
                <Form onSubmit={this.handleSubmit}>
                    <Form.Item validateStatus={descriptiontNameError ? 'error' : ''} help={descriptiontNameError || ''}>
...
export default connect(null, { runSimulation })(Form.create({ name: 'horizontal_product' })(DescriptionForm))
